...
> **⚠️ Key Difference**: Atomic stacks share the same working copy (unlike Git branches). Read about [how stacks work](./commands/stacks#️-critical-difference-stacks-are-not-git-branches) before switching between them.
